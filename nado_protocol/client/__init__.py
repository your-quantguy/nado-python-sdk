...
def create_nado_client(
    ...
    anyurl_adapter = TypeAdapter(AnyUrl)
    context = create_nado_client_context(
        NadoClientContextOpts(
            rpc_node_url=rpc_node_url,
            engine_endpoint_url=anyurl_adapter.validate_python(engine_endpoint_url),
            indexer_endpoint_url=anyurl_adapter.validate_python(indexer_endpoint_url),
            trigger_endpoint_url=anyurl_adapter.validate_python(trigger_endpoint_url),
